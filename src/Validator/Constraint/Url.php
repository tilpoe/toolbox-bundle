...
class Url extends Constraint implements ConstraintInterface {
    ...
    public function __construct(
        ...
        parent::__construct(Constraint::URL, $message, $condition);
    }
    ...
    public function validate(mixed $value): ?Violation {
        if ($this->condition) {
            ...
            $pattern = $this->relativeProtocol ? str_replace('(%s):', '(?:(%s):)?', self::PATTERN) : self::PATTERN;
